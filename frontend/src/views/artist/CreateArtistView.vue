...
import { useAuthStore } from "@/stores/auth"; // Import if needed for updating store
...
const authStore = useAuthStore(); // Initialize if needed
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Force a refresh of user data to include the new artist profile link
    await authStore.fetchUser(router); // Pass router if fetchUser uses it
